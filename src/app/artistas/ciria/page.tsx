    ...
    <div className="min-h-screen bg-white">
      <section className="relative h-[60vh] bg-black overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center z-10 px-4">
          ...
          >
            "El anhelo de atrapar ese lugar y no otro. Hacer pinturas, que antes
            de otra cosa, me produzcan “dolor” de estomago."
          </motion.p>
          ...
          <div className="md:col-span-8 space-y-6">
            ...
            >
              <p className="text-xl leading-relaxed text-gray-700">
                En ocasiones, quizá las mejores cuando enfrentamos la obra de un
                artista se produce una profunda sensación de extrañeza, de
                desubicación, de desplazamiento o disloque, que puede estar
                sustentada en lo que ya conocemos, en lo que es común, en algo
                asimilado y que no resulta sorprendente, pero que sin saber
                explicar su porqué es capaz de atenazarnos y pegársenos
                profundamente a las tripas.
              </p>
              <p className="text-xl leading-relaxed text-gray-700">
                José Manuel Ciria nace en Manchester el 3 de Febrero de 1960, de
                padres españoles (Santiago y Gloria), permanece en Inglaterra
                hasta la edad de los ocho años; momento en que sus padres
                deciden regresar a Madrid.
              </p>
            </motion.div>
            <motion.button
              initial={{ opacity: 0 }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                >
                  ...
                  <p className="text-lg leading-relaxed text-gray-700">
                    Desde que en 1984 realizara su primera muestra individual en
                    la galería parisina La Ferrière, Ciria ha trazado una amplia
                    trayectoria jalonada por numerosas exposiciones y premios.
                  </p>
                  <p className="text-lg leading-relaxed text-gray-700">
                    En los últimos años, su figura ha adquirido una amplia
                    proyección internacional a través de sus muestras
                    individuales en prestigiosos museos alrededor del mundo.
                  </p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, scale: 0.95 }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      Primera etapa ligada a una figuración de carácter
                      expresionista
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      Diálogo entre el fluir azaroso de la mancha y el rigor de
                      la geometría
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      Enfriamiento pictórico y recuperación de la línea como
                      armazón compositivo
                    </p>
                  </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8">
                  {[
                    ...
                    },
                    {
                      ...
                      detalle:
                        "Ingresa en la Facultad de Bellas Artes de Madrid",
                    },
                    {
                      año: "1994-1995",
                    ...
                    },
                    {
                      ...
                      detalle:
                        "'Ciria, Pronunced Thiria' en Nueva York y Berlín",
                    },
                  ].map((item, index) => (
                    <motion.div
                      key={item.año}
              ...
              <div className="rounded-2xl bg-gray-50 p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="text-gray-600">
                        Museo Extremeño e Iberoamericano del Arte Contemporáneo
                        (MEIAC), Badajoz
                      </li>
                      <li className="text-gray-600">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="text-gray-600">
                        Colección Banco Portugués de Negocios (BPN), Oporto
                        (Portugal)
                      </li>
                      <li className="text-gray-600">
                ...
                <div className="mt-12 p-6 bg-white rounded-xl shadow-sm">
                  <p className="text-gray-500 italic">
                    ...
                    colecciones adicionales alrededor del mundo, incluyendo
                    múltiples ayuntamientos, fundaciones y colecciones privadas.
                  </p>
                </div>
              </div>
            </motion.div>
