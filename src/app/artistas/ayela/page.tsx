    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] bg-black overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center z-10 px-4">
          ...
          >
            "Queriendo extraer experiencia desde lo concreto y significado desde
            la experiencia, la obra se definirá desde lo procesual como
            exploración abierta del entorno y de los medios."
          </motion.p>
          ...
          <div className="md:col-span-8 space-y-6">
            ...
            >
              <p className="text-xl leading-relaxed text-gray-700">
                La aparente simplicidad de las imágenes, así como la carga de
                humor y sentido de lo lúdico, esconden, sin embargo, claves
                interpretativas complejas que cuestionan las dicotomías entre
                peso y levedad, épico y trivial, tangible e ilusorio.»
              </p>
            </motion.div>
            <motion.button
              initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="relative h-[60vh] rounded-3xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-12">
                  ...
                  >
                    Mi trabajo parte de la observación de lo fenomenológico en
                    relación con las estructuras del imaginario cultural.
                  </motion.p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                >
                  ...
                  <p className="text-lg leading-relaxed text-gray-700">
                    ...
                    evidenciar su conflicto de sustitución.
                    <br />
                    Queriendo extraer experiencia desde lo concreto y
                    significado desde la experiencia, la obra se definirá desde
                    lo procesual como exploración abierta del entorno y de los
                    medios.
                    <br />
                    Se trata de activar, a través de la imaginación, la
                    naturaleza dinámica de lo real frente al reduccionismo de
                    los condicionamientos mediáticos del cliché y la inercia
                    cultural.
                  </p>
                  <p className="text-lg leading-relaxed text-gray-700">
                    Y aprender por contacto, no por conciencia.
                    <br />
                    <br />A partir del uso heterodoxo de materiales comunes y la
                    investigación de otros alternativos, o la combinación de
                    medios tecnológicos con manualidades rudimentarias, procuro
                    conectar, desde el ensayo de los estilos, con la
                    fenomenología esencial de la expresión estética. No solo
                    como motor de significado sino, sobre todo, como motor de
                    realidad.
                  </p>
                  <p className="text-lg leading-relaxed text-gray-700">
                    “(…)el signo era la cosa que se podía pensar y el signo de
                    la cosa pensada, o sea de sí mismo.” Italo Calvino Un signo
                    en el espacio
                  </p>
                </motion.div>
                <motion.div
